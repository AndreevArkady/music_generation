...
# LrStepTracker
class LrStepTracker(object):
    """Class for custom learn rate scheduler.
    ...
    Class should be used by torch.optim.lr_scheduler.LambdaLR
    ...
    def __init__(self, model_dim=512, warmup_steps=4000, init_steps=0):
        ...
        Args:
            ...
            warmup_steps: duration of increasing lr (warmup) in steps
            init_steps: int
        """
        # Store Values
    ...
    # step
    def step(self, step):
        """Increment the step and computes the new learn rate.
...
def get_lr(optimizer):
    ...
    Args:
        optimizer: function generator

    Returns:
        lr: current learn rate of the model

    Author: Damon Gwinn
    """
    for param_group in optimizer.param_groups:  # noqa: WPS328
